...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--dataset1', type=str, default='cifar10', help='CIFAR10 / MNIST / FashionMNIST')
        parser.add_argument('--dataset2', type=str, default='cifar100', help='CIFAR100 / MNIST / FashionMNIST')
        # parser.add_argument('--mode', type=int, required=True, help='interleaving mode')
        ...
        parser.add_argument('--alpha_lr', type=float, default=3e-5, help='lr for alpha')
        parser.add_argument('--alpha_weight_decay', type=float, default=1e-4,
    ...
    def __init__(self):
        ...
        self.data_path = '/home/featurize/data/'
        self.path = os.path.join('searches', self.name) # 模型保存的父文件路径
